...
class Harvest:
    ...
    def __init__(self):
        self.time_entries, self.date_range = self.load_data()
    ...
    def load_data(self):
        ...
        # Find the earliest and latest date in the data, create a range of weekdays between these dates
        date_range = get_business_days(time_entries['spent_date'].min(), time_entries['soent_date'].max())

        return time_entries, date_range
